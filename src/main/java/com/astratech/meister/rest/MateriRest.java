...
public class MateriRest {
    ...
    public ResponseEntity<Void> edit(RedirectAttributes flashmsg
            ...
            , @RequestParam(value="edit_bagian") Bagian edit_bagian
